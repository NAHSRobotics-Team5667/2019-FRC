...
public class CargoCommand extends CommandBase {
  private CargoSubsystem CargoIntake;
   ...
   */
  public CargoCommand(CargoSubsystem CargoIntake) {
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(CargoIntake);
